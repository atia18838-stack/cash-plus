...
export function SignInForm() {
  ...
  // 🔑 اكتب هنا اليوزر والباسورد اللي تحب تدخل بيهم:
  const ADMIN_EMAIL = "temsahstore@gmail.com"; 
  const ADMIN_PASSWORD = "023304";
        ...
        <div className="p-8">
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              // 🟢 تسجيل دخول بسيط باليوزر والباسورد الثابتين:
              ...
              // 🔵 تجربة التسجيل عبر Convex لو البيانات مختلفة:
